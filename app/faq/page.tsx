    ...
    <>
      ...
      <main className="bg-white min-h-screen">
        ...
        <section className="bg-pink-50 py-16 px-4 text-center">
          ...
          <h1 className="text-4xl font-light text-gray-700">FAQ</h1>
        </section>
        ...
        <div className="max-w-2xl mx-auto px-4 py-16 flex flex-col gap-16">
          ...
          {/* Hébergements */}
          <section>
            <h2 className="text-xl font-medium text-gray-700 mb-2">Où dormir ?</h2>
            ...
            <div className="flex flex-col gap-4">
              {hebergements.map((h, i) => (
                <div key={i} className="bg-pink-50 rounded-2xl p-6">
                  ...
                  <p className="text-sm text-gray-400 mt-2">{h.adresse}</p>
                  <p className="text-sm text-gray-400">{h.telephone}</p>
                  <a
                    href={h.site}
          ...
          {/* Transport */}
          <section>
            <h2 className="text-xl font-medium text-gray-700 mb-6">Comment venir ?</h2>
            <div className="flex flex-col gap-4">
          ...
          {/* Dress code */}
          <section>
            <h2 className="text-xl font-medium text-gray-700 mb-6">Quelle tenue porter ?</h2>
            <div className="bg-pink-50 rounded-2xl p-6">
          ...
          {/* Contact */}
          <section>
            <h2 className="text-xl font-medium text-gray-700 mb-6">Qui contacter ?</h2>
            <div className="bg-pink-50 rounded-2xl p-6">
