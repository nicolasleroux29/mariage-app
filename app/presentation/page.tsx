  ...
  return (
    <>
      ...
      <main className="bg-white min-h-screen">
        ...
        {/* Hero */}
        <section className="bg-pink-50 py-24 sm:py-32 px-6 text-center">
          <p className="text-pink-400 text-sm uppercase tracking-widest mb-6">Yann &amp; Judith</p>
          <h1 className="text-3xl sm:text-4xl font-light text-gray-700 font-serif">
        ...
        <div className="max-w-2xl mx-auto px-4 py-24 flex flex-col gap-24">
          ...
          {/* Les mariés */}
          <section>
            <h2 className="text-xl font-medium text-gray-700 mb-8 font-serif">Yann &amp; Judith</h2>
            <div className="flex flex-col sm:flex-row gap-8 items-start">
              ...
              <div className="flex flex-col gap-5 text-base text-gray-500 leading-loose">
                <p>
          ...
          {/* Nos témoins */}
          <section>
            <h2 className="text-xl font-medium text-gray-700 mb-8 font-serif">Nos témoins</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              {temoins.map((temoin, i) => (
                <div key={i} className="bg-pink-50 rounded-2xl p-8 flex flex-col items-center text-center gap-5">
                  ...
                  <p className="text-base text-gray-500 leading-loose">{temoin.bio}</p>
                </div>
              ))}
            </div>
          </section>
